      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Log In Successfull');
  ...
  _logout = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          (0, _alerts.showAlert)('success', 'loggin out..');
          _context2.next = 4;
          return (0, _axios.default)({
            method: 'GET',
        ...
        case 8:
          ...
          (0, _alerts.showAlert)('error', 'UnExpected Error! Try Again later!');
        case 12:
        case "end":
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXFpYnNob2FpYiIsImEiOiJjbHlvMHhucXMwZWtjMmtxeW9haDN4ZGZwIn0.iZqFiFMYXr7BtgNaXrZwuA';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/aqibshoaib/clyo98asl00b401plae8o1tcv',
    scrollZoom: false
  });
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(type, data) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          console.log(data);
          url = type === 'data' ? 'http://127.0.0.1:8000/api/v1/users/updateMe' : 'http://127.0.0.1:8000/api/v1/users/update-password';
          _context.prev = 2;
          _context.next = 5;
          return (0, _axios.default)({
            method: 'PATCH',
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /*eslint-disable*/
var loginFormEl = document.querySelector('.from--login');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateData.updateData)('data', form);
  });
}
if (userPasswordForm) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 6;
            return (0, _updateData.updateData)('password', {
